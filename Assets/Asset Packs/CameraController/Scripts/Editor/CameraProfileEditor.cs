...
#else
        SerializedProperty ZoomIn;
        SerializedProperty ZoomOut;
        SerializedProperty Drag;
        SerializedProperty Rotate_Left;
        SerializedProperty Rotate_Right;        
        SerializedProperty SpeedBoost;
#endif
...
#else
            ZoomIn = serializedObj.FindProperty("ZoomIn");
            ZoomOut = serializedObj.FindProperty("ZoomOut");
            Drag = serializedObj.FindProperty("Drag");
            Rotate_Left = serializedObj.FindProperty("Rotate_Left");
            Rotate_Right = serializedObj.FindProperty("Rotate_Right");
            SpeedBoost = serializedObj.FindProperty("SpeedBoost");
#endif
